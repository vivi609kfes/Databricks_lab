...
tableName = 'company_summary_fact'
...
windowSpec = Window.orderBy('company_id')
...
mySchema = StructType(
    [
        ...
        StructField("metric_count"                                ,IntegerType(),True),
        StructField("emission_count"                              ,DecimalType(38,18),True),
        StructField("certificate_count"                           ,IntegerType(),True),
        StructField("project_count"                               ,IntegerType(),True),
        StructField("issued_credit_count"                         ,IntegerType(),True),
        StructField("retired_credit_count"                        ,IntegerType(),True),
        StructField("retired_credit_retirement_beneficiary_count" ,IntegerType(),True),
        StructField("membership_count"                            ,IntegerType(),True),
        StructField("report_count"                                ,IntegerType(),True),
        ...
        StructField("risk_alert_count"                            ,IntegerType(),True),
...
create_temp=f"""create table if not exists {rds_credential.get('dbname')}.{tableName_temp} 
            (
                ...
                emission_count                                  numeric(50, 7),
                certificate_count                               Integer,
                project_count                                   Integer,
                issued_credit_count                             Integer,
                retired_credit_count                            Integer,
                retired_credit_retirement_beneficiary_count     Integer,
