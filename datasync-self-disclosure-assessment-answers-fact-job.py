...
tableName = 'self_disclosure_assessment_answers_fact'
...
windowSpec = Window.orderBy('company_id','self_disclosure_assessment_answer_id')
...
mySchema = StructType(
    [
        ...
        StructField("self_disclosure_assessment_answer_id"          ,StringType(),True),
        StructField("self_disclosure_framework"                     ,StringType(),True),
        StructField("self_disclosure_assessment_question_code"      ,StringType(),True),
        StructField("self_disclosure_assessment_answer"             ,StringType(),True),
        StructField("self_disclosure_assessment_unit"               ,StringType(),True),
        StructField("self_disclosure_assessment_year"               ,IntegerType(),True),
        StructField("self_disclosure_assessment_date"               ,TimestampType(),True),
        StructField("self_disclosure_assessment_version"            ,StringType(),True),
...
create_temp=f"""create table if not exists {rds_credential.get('dbname')}.{tableName_temp} 
            (
                ...
                ,self_disclosure_assessment_answer_id      varchar(256)
                ,self_disclosure_framework                 varchar(256)
                ,self_disclosure_assessment_question_code  varchar(256)
                ,self_disclosure_assessment_answer         varchar(256)
                ,self_disclosure_assessment_unit           text
                ,self_disclosure_assessment_year           integer
                ,self_disclosure_assessment_date           Datetime
                ,self_disclosure_assessment_version        varchar(256)
                ,id                                 integer
                ,PRIMARY KEY (id)     
            )
            ;
