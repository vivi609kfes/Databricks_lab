...
tableName = 'self_disclosure_scores_fact'
...
windowSpec = Window.orderBy('company_id','esgpedia_self_disclosure_score_id')
...
mySchema = StructType(
    [
        ...
        StructField("esgpedia_self_disclosure_score_id"             ,StringType(),True),
        StructField("self_disclosure_score_framework"               ,StringType(),True),
        StructField("self_disclosure_score_type"                    ,StringType(),True),
        StructField("self_disclosure_score_year"                    ,StringType(),True),
        StructField("self_disclosure_score"                         ,StringType(),True),
...
create_temp=f"""create table if not exists {rds_credential.get('dbname')}.{tableName_temp} 
            (
                ...
                ,esgpedia_self_disclosure_score_id  varchar(256)
                ,self_disclosure_score_framework    varchar(3)
                ,self_disclosure_score_type         varchar(266)
                ,self_disclosure_score_year         bigint
                ,self_disclosure_score              varchar(256)
                ,id                                         integer
                ,PRIMARY KEY (id)
            )
            ;
