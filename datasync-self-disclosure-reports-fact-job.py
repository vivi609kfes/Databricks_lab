...
tableName = 'self_disclosure_reports_fact'
...
windowSpec = Window.orderBy('company_id','esgpedia_self_disclosure_report_id')
...
mySchema = StructType(
    [
        ...
        StructField("esgpedia_self_disclosure_report_id"            ,StringType(),True),
        StructField("self_disclosure_report_framework"              ,StringType(),True),
        StructField("self_disclosure_report_year"                   ,StringType(),True),
        StructField("self_disclosure_report_type"                   ,StringType(),True),
        StructField("self_disclosure_report_link"                   ,StringType(),True),
...
create_temp=f"""create table if not exists {rds_credential.get('dbname')}.{tableName_temp} 
            (
                ...
                ,esgpedia_self_disclosure_report_id  varchar(256)
                ,self_disclosure_report_framework    varchar(10)
                ,self_disclosure_report_year         text
                ,self_disclosure_report_type         text
                ,self_disclosure_report_link         text
                ,to_show                             boolean
                ,id                                         integer
                ,PRIMARY KEY (id)
            )
